    	...
    	<div class="secnd_navi">
        	<ul class="links">
            	<li>Default welcome msg!</li>
							 @if(Auth::check())
                <li><a href="account.html">Xinchao{{Auth::user()->name}}</a></li>
                      ...
                      <h3>Please input</h3>
                        ...
                        <ul class="forms">
                          <li class="txt">Fullname<span class="req"></span></li>
                            <li class="inputfield"><input type="text" name="fullname" class="bar" value="" >
                            </li>
                        </ul>
                        <ul class="forms">
                          <li class="txt">Email<span class="req"></span></li>
                            <li class="inputfield"><input type="text" name="email" class="bar" value=""></li>
                        </ul>
                        <ul class="forms">
                          <li class="txt" >Password<span class="req"></span></li>
                            <li class="inputfield"><input type="password" name="password" class="bar" placeholder="Tối thiểu 8 ký tự" ></li>
                        </ul>
                        <ul class="forms">
                          <li class="txt">Retype Pass<span class="req"></span></li>
                            <li class="inputfield"><input type="password" name="re_password" class="bar" ></li>
                        </ul>
                        <ul class="forms">
                          <li class="txt">Mobile<span class="req"></span></li>
                            <li class="inputfield"><input type="text" name="mobile" class="bar" value=""></li>
                        </ul>
                      <ul class="forms">
                        <li class="txt">Address<span class="req"></span></li>
                        <li><textarea name="address" rows="8" cols="50"></textarea></li>
                      </ul>
                        <ul class="forms">
                          <li class="txt">&nbsp;</li>
